 ...
 * @author cw1491
 */
@WebServlet(name = "LoginRetrievalServlet", urlPatterns = {"/LoginRetrievalServlet"})
public class LoginRetrievalServlet extends HttpServlet {
        ...
        try {
            ...
            for (Login curLogin : matchingLogins) {
                out.println(curLogin.getId() + ", "
                        + curLogin.getPerson().getFirstName() + "<br/>");
            }
        }catch(Exception e){
            e.printStackTrace();
        } finally {
