 ...
 * @author cw1491
 */
@WebServlet(name = "PersonRetrievalServlet", urlPatterns = {"/PersonRetrievalServlet"})
public class PersonRetrievalServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (Person curPerson : matchingPeople) {
                out.println(curPerson.getLogin().getId()+" "+curPerson.getFirstName()+" cities: ");
                for (Address curAddress : curPerson.getAddresses()){
                    out.println(curAddress.getCity()+" ");
                }
                out.println("phones: ");
