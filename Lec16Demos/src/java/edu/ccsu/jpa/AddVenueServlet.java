 ...
 * @author cw1491
 */
@WebServlet(name = "AddVenueServlet", urlPatterns = {"/AddVenueServlet"})
public class AddVenueServlet extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      out.println("<html>");
      out.println("<head>");
      out.println("<title>Servlet AddVenueServlet</title>");      
      out.println("</head>");
      out.println("<body>");
      ...
      Set<Venue> venues = city.getVenues();
      venues.add(venue);
      city.setVenues(venues);
      entityManager.persist(city);
      entityManager.persist(venue);
      entityManager.getTransaction().commit();
      out.println("Venue added: "+venue.getName()+"<br/>");
      out.println("</body>");
      out.println("</html>");
    }catch(Exception e){
