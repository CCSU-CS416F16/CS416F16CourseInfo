 ...
 * @author cw1491
 */
@WebServlet(name = "JDBCDeletePersonServlet", urlPatterns = {"/JDBCDeletePersonServlet"})
public class JDBCDeletePersonServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (recordsAffected==0){
                ...
                out.println(recordsAffected+" records were deleted");
            }
