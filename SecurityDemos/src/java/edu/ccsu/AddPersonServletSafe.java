 ...
 * @author cw1491
 */
@WebServlet(name = "AddPersonServletSafe", urlPatterns = {"/AddPersonServletSafe"})
public class AddPersonServletSafe extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            sql = "insert into person (id,firstname,lastname) values (?,?,?)";
            PreparedStatement insertPerson = connection.prepareStatement(sql);
            insertPerson.setInt(1, nextId);
